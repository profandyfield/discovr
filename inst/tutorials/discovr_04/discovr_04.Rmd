...
description: "Summarizing data: mean, median, variance, standard deviation, interquartile range,  normal and bootstrap confidence intervals, tables of summary statistics. Includes an interactive app demonstrating what a confidence interval is."
...
## `r bmu()` Confidence intervals [(1)]{.alt}
...
## `r bmu()` Easier descriptives using `datawizard` [(1)]{.alt}
...
## `r bmu()` Nicer tables with insight [(1)]{.alt}
