...
# This is because obq has 2 missing values, which means that soc_anx_lm is based on 134 cases but when we include obq in the model, we exclude the missing cases so soc_anx_obq_lm is based on 132 cases. We, therefore, can't compare the models because they're based on different numbers of observations!
# Now view parameters for the final model
