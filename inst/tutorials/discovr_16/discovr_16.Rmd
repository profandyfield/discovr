...
### `r user_visor()` The main effect of **personality** [(B)]{.lbl}
...
### `r user_visor()` The interaction between **strategy** and **personality** [(B)]{.lbl}
...
### `r user_visor()` The interaction between **looks** and **personality** [(B)]{.lbl}
...
### `r user_visor()` The interaction between **strategy**, **looks** and **personality** [(B)]{.lbl}
