...
## Don't show: 
if (identical(Sys.getenv("NOT_CRAN"), "true") && require("rstanarm")) withAutoprint({ # examplesIf
## End(Don't show)
library(bayestestR)
library(rstanarm)
...
## Don't show: 
if (require("ggdist")) withAutoprint({ # examplesIf
## End(Don't show)
library(ggplot2)
library(see)
...
## Don't show: 
if (require("ggside") && require("ggplot2")) withAutoprint({ # examplesIf
## End(Don't show)
library(ggplot2)
...
## Don't show: 
if (requireNamespace("patchwork", quietly = TRUE)) withAutoprint({ # examplesIf
## End(Don't show)
library(ggplot2)
library(see)
...
## Don't show: 
if (require("ggdag", quietly = TRUE)) withAutoprint({ # examplesIf
## End(Don't show)
library(performance)
...
## Don't show: 
if (identical(Sys.getenv("NOT_CRAN"), "true") && require("randomForest")) withAutoprint({ # examplesIf
## End(Don't show)
library(performance)
m <<- lm(mpg ~ wt + cyl + gear + disp, data = mtcars)
...
## Don't show: 
if (require("patchwork") && FALSE) withAutoprint({ # examplesIf
## End(Don't show)
library(performance)
...
## Don't show: 
if (require("qqplotr")) withAutoprint({ # examplesIf
## End(Don't show)
...
## Don't show: 
if (require("ggrepel")) withAutoprint({ # examplesIf
## End(Don't show)
...
## Don't show: 
if (all(insight::check_if_installed(c("marginaleffects", "Formula"), quietly = TRUE))) withAutoprint({ # examplesIf
## End(Don't show)
## Don't show: 
}) # examplesIf
## End(Don't show)
...
## Don't show: 
if (require("nFactors")) withAutoprint({ # examplesIf
## End(Don't show)
data(mtcars)
...
## Don't show: 
if (require("brms") && require("metafor") && require("RcppEigen") && require("BH")) withAutoprint({ # examplesIf
## End(Don't show)
## Don't show: 
}) # examplesIf
## End(Don't show)
...
## Don't show: 
if (require("glmmTMB") && require("qqplotr") && require("DHARMa")) withAutoprint({ # examplesIf
## End(Don't show)
...
## Don't show: 
if (require("patchwork", quietly = TRUE)) withAutoprint({ # examplesIf
## End(Don't show)
library(ggplot2)
library(see)
