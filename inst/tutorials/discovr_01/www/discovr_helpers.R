...
alien <- function(fill = purp, height = 1){
...
robot <- function(fill = purp, height = 1){
...
bmu <- function(fill = purp, height = 1){
...
user_astronaut <- function(fill = purp, height = 1){
...
user_visor <- function(fill = purp, height = 1){
