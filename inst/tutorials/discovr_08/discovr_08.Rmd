...
```{r album_lm_diag, exercise = TRUE, exercise.lines = 4}
...
```{r album_full_diag, exercise = TRUE, exercise.lines = 4}
...
```{r metal_health, exercise = TRUE, exercise.lines = 10}
...
```{r soc_anx, exercise = TRUE, exercise.lines = 15}
