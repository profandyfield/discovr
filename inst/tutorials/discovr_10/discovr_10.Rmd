...
Moderation is shown up by a significant interaction effect, and that's what we've got here, $\hat{b}$ = `r report_pars(agg_tidy, row = 4, digits = 3)` indicating that the relationship between the time spent gaming and aggression is moderated by callous traits. (Remember that [1.221295e-04]{.adj} is $1.22 \times 10^{-4}$ or 0.000122.)
