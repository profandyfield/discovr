...
> and yet-to-be updated tutorials. For this reason, I strongly recommend
...
- **discovr_03**: The tidyverse: tidy and messy data, tibbles, adding
  and selecting variables, filtering cases.
