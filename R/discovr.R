...
#' * **discovr_10**: Moderation and mediation. Centering variables (grand mean centering), specifying interaction terms, moderation analysis, simple slopes analysis, Johnson-Neyman intervals, mediation with one predictor, direct and indirect effects, mediation using lavaan.
#'
#' **Workflow**:
...
#' * [album_sales]: Ficticious data about predicting album sales from advertising, airplay and the band's image. (Also in the file *album_sales.csv*.)
#' * [animal_bride]: Ficticious data about life satisfaction when married to a dog or a goat. (Also in the file *animal_bride.csv*.)
#' * [beckham_1929]: Data from a study by Beckham (1929). (Also in the file *beckham_1929.csv*.)
#' * [big_hairy_spider]: Ficticious data about whether anxiety is greater after exposure to real spiders or pictures of spiders. (Also in the file *big_hairy_spider.csv*.)
#' * [biggest_liar]: Ficticious data about creativity and telling lies. (Also in the file *biggest_liar.csv*.)
...
#' * [catterplot]: Ficticious data for plotting a catterplot. (Also in the file *catterplot.csv*.)
#' * [cat_dance]: Ficticious data about training cats to dance. (Also in the file *cat_dance.csv*.)
#' * [cat_reg]: Ficticious data about training cats to dance. (Also in the file *cat_reg.csv*.)
...
#' * [child_aggression]: Ficticious data (based on real research) about predicting aggression in children. (Also in the file *child_aggression.csv*.)
...
#' * [dark_lord]: Ficticious data about the subliminal messages in songs. (Also in the file *dark_lord.csv*.)
#' * [download]: Ficticious data about the download music festival and being smelly. (Also in the file *download_festival.csv*.)
#' * [df_beta]: Ficticious data used to illustrate the DF Beta statistic. (Also in the file *df_beta.csv*.)
#' * [essay_marks]: Ficticious data about essay marking. (Also in the file *essay_marks.csv*.)
#' * [exam_anxiety]: Ficticious data about exam performance, anxiety and revision. (Also in the file *exam_anxiety.csv*.)
...
#' * [glastonbury]: More ficticious data about music festivals and being smelly. (Also in the file *glastonbury.csv*.)
#' * [grades]: Ficticious data about statistics grades. (Also in the file *grades.csv*.)
#' * [ice_bucket]: Data about the ice bucket challenge. (Also in the file *ice_bucket.csv*.)
#' * [invisibility_cloak]: Ficticious data about how much mischief peopel would get up to if they had an invisibility cloak. (Also in the file *invisibility.csv*.)
#' * [invisibility_rm]: Ficticious data about how much mischief peopel would get up to if they had an invisibility cloak but using a repeated measures design. (Also in the file *invisibility_rm.csv*.)
#' * [hiccups]: Ficticious data on digital rectal stimulation and hiccups. (Also in the file *hiccups.csv*.)
#' * [honesty_lab]: Ficticious data about perceptions of honesty. (Also in the file *honesty_lab.csv*.)
#' * [jiminy_cricket]: Ficticious data about whether wishing on a star makes you successful. (Also in the file *jiminy_cricket.csv*.)
...
#' * [men_dogs]: Ficticious data about whether men exhibit dog-like behaviours (compared to dogs). (Also in the file *men_dog.csv*.)
#' * [metal_health]: Ficticious data about whether listening to heavy metal negatively affects mental health. (Also in the file *metal_health.csv*.)
#' * [metallica]: Data about thrash metal nband, Metallica. (Also in the file *metallica.csv*.)
#' * [notebook]: Ficticious data about whether watching the film the notebook is emotionally arousing. (Also in the file *notebook.csv*.)
...
#' * [pubs]: Data illustrating the difference between an outlier and an influencial case. (Also in the file *pubs.csv*.)
#' * [r_exam]: Fictitious data relating to an R exam at two universities. (Also in the file *r_exam.csv*.)
#' * [roaming_cats]: Ficticious data about how far cats roam from their homes (Also in the file *roaming_cats.csv*.)
#' * [self_help]: Ficticious data about whether self-help books improve relationship satisfaction. (Also in the file *self_help.csv*.)
#' * [self_help_dsur]: Ficticious data about whether self-help books improve relationship satisfaction compared to statistics books. (Also in the file *self_help_dsur.csv*.)
#' * [social_anxiety]: Ficticious (I think) data about whether social anxiety symptoms are specific to social anxiety. (Also in the file *social_anxiety.csv*.)
#' * [social_media]: Ficticious data about the effects of social media on grammar. (Also in the file *social_media.csv*.)
#' * [shopping]: Ficticious data about shopping (Also in the file *shopping_exercise.csv*.)
#' * [students]: I can't even remember what this data file contains. (Also in the file *student.csv*.)
#' * [supermodel]: Ficticious data about supermodel salaries. (Also in the file *supermodel.csv*.)
#' * [tablets]: Ficticious data about predicting the desirability of computing tablets. (Also in the file *tablets.csv*.)
#' * [tea_15]: Ficticious data based on real data about cognitive functioning and drinking tea. (Also in the file *tea_makes_you_brainy_15.csv*.)
#' * [tea_716]: Ficticious data based on real data about cognitive functioning and drinking tea. (Also in the file *tea_makes_you_brainy_716.csv*.)
#' * [teaching]: Ficticious data about the success of different methods of treaching. (Also in the file *method_of_teaching.csv*.)
#' * [video_games]: Ficticious data about the relationship between video game use, callous unemotional traits and aggression. (Also in the file *video_games.csv*.)
