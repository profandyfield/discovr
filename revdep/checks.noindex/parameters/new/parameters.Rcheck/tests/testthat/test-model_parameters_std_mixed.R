...
test_that("model_parameters, standardize-refit, wald-normal", {
  ...
  expect_equal(
    params$Coefficient,
    c(0.96949, -1.28631, -1.81461, 0.34791, 1.74252, -0.25421, -0.18834),
    tolerance = 1e-3
  )
  expect_equal(
    params$SE,
  ...
  expect_equal(
    params$CI_high,
    c(1.37031, -0.77301, -1.14754, 0.46488, 2.01523, -0.06287, -0.00312),
    tolerance = 1e-3
  )
})
...
test_that("model_parameters, standardize-refit, wald-t", {
  ...
  expect_equal(
    params$CI_high,
    c(1.37378, -0.76856, -1.14177, 0.4659, 2.01759, -0.06121, -0.00151),
    tolerance = 1e-3
  )
})
...
test_that("model_parameters, standardize-refit robust", {
  ...
  expect_equal(
    params$CI_high,
    c(1.12224, -0.6259, -1.36691, 0.45151, 1.94204, 0.11227, -0.07858),
    tolerance = 1e-3
  )
})
