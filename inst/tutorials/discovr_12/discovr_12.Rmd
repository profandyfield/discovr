...
Plot a violin plot of happiness scores in the three puppy therapy groups. Plot the raw data and display each group in a different colour. Include `scale_colour_viridis_d(begin = 0.3, end = 0.8)` so that the plot uses accessible colours.
