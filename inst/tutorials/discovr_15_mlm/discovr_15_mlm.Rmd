...
Use what you already know to create an object called [sniff_sum]{.alt} that contains the mean and a 95% confidence interval of vocalizations split by the entity sniffedn. Print this object rounding to 2 decimal places and with a caption.
