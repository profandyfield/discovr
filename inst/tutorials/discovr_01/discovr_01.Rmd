...
###	Creating new variables within a tibble with `dplyr::mutate()`
...
which you can read as 'the variable `instrument` within the tibble `metalli_tib`'. Try this out below:

```{r met_select_base, exercise=TRUE, exercise.setup = "met_setup"}
