...
ss.tib<-tibble(score, error, error_2)
...
t7.tib<-tibble(Score, Mean, Difference, d2)
...
t8.tib<-tibble(score, error, error_2)
...
t9.tib<-tibble(score, error, error_2)
...
t10.tib<-tibble(score, error, error_2)
