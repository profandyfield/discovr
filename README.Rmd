...
However, the package is currently in constant development to get the most recent version install it from github. 
...
- **discovr_02**: Key concepts in <img src="./data-raw/images/r_logo.png" width="18"> (functions and objects, packages and functions, style, data types, tidyverse, tibbles)
- **discovr_03**: Summarizing data (frequency distributions, grouped frequency distributions, relative frequencies, histograms, mean, median, variance, standard deviation, interquartile range)
- **discovr_04**: Confidence intervals: interactive app demonstrating what a confidence interval is, computing normal and bootstrap confidence intervals using <img src="./data-raw/images/r_logo.png" width="18">, adding confidence intervals to data summaries.
