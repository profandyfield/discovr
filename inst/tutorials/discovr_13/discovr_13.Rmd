...
parameters::model_parameters(goggles_lm, vcov = TRUE, vcov.type = "HC4", digits = 3) |> 
  knitr::kable(digits = 3) 
```
...
```{r xbox_hc4-solution}
parameters::model_parameters(xbox_lm, vcov = TRUE, vcov.type = "HC4") |> 
  knitr::kable(digits = 3)
```
