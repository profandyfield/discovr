...
Using what you've learnt in previous tutorials, create a tibble called `rehab_sum` containing the group means of the variables **resemblance** and **months_as_zombie** and their confidence intervals split by **clinic_id** and **intervention** (in that order).
...
### `r user_visor()` *F*-statistics for fixed effects [(2)]{.alt}
...
### `r user_visor()` Viewing the model parameters [(2)]{.alt}
