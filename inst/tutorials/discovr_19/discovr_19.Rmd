...
Basically, input your contingency table [cat_xtbl]{.alt} to the function and you're good to go. The other argument is [correct = TRUE]{.alt} which, by default, applies Yates' continuity correction when the contingency table is 2 $\times$ 2 in size. There's no reason to change this default to FALSE so we can exclude this argument.
