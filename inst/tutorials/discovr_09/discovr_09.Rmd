...
## `r bmu2()` Comparing two means: process
...
## `r bmu2()` Comparing two independent means
...
### `r user_visor()` Effect size for independent means
...
## `r bmu2()` Comparing two dependent means
...
### `r user_visor()` Effect sizes for dependent means
...
## `r user_astronaut()` Robust models
