...
It also uses these [tidyverse]{.pkg} packages [@R-tidyverse; @tidyverse2019]: [dplyr]{.pkg} [@R-dplyr] and [readr]{.pkg} [@R-readr].
...
## `r bmu()` An `r rproj()`-induced anxiety example  [(B)]{.lbl}
...
### `r bmu()` Inspect the correlation matrix  [(B)]{.lbl}
...
### `r bmu()` Bartlett's test and the KMO test  [(B)]{.lbl}
...
## `r bmu()` Reliability analysis [(B)]{.lbl}
